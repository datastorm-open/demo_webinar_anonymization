...
#'
#' @param data \code{data.table}. The demo dataset to be k-anonymized.
...
k_anonymize_bdd <- function(data, 
  ...
  data[, c("Nom", "freq. activites mensuelles cut") := NULL]
  ...
  data_bin <- to_dummy(data[, -c("Risque hypertension", "Risque tachycardie", "Strava", "Twitter", "Facebook", "Opt_in"), with = F], 
  ...
  cols_num <- names(which(sapply(data[, -c("Risque hypertension", "Risque tachycardie", "Strava", "Twitter", "Facebook", "Opt_in")], is.numeric)))
  ...
  cols_char <- names(which(sapply(data[, -c("Risque hypertension", "Risque tachycardie", "Strava", "Twitter", "Facebook", "Opt_in")], is.character)))
  ...
  data_anonym[, (c("Risque hypertension", "Risque tachycardie", "Strava", "Twitter", "Facebook", "Opt_in")) := 
                data[, c("Risque hypertension", "Risque tachycardie", "Strava", "Twitter", "Facebook", "Opt_in"), with = F]]
